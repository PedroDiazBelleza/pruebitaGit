           ...
           <h2>Productos de tendencia</h2> 
            ...
            misDatos.forEach(midato => {
                ...
                <div style="background: white;display:grid;width:200px; height: 300px; margin:2rem; border-radius:16px">
                    ...
                    <div class="act_prod">
                        <button style="background: #0099E1; border: 0; border-radius:16px; width:70%; color: white" onclick="window.location='control?opc=2&codProd=${midato.cod_prod}&codProv=${midato.cod_prov}'" >Comprar ahora</button>
                    </div>
                </div>`;
            })
            template += `</div>`;
